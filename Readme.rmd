  ...
  - Fase 03 do projeto de banco de dados é feita tanto pelo administrador de bancos de dados(DBA) quanto administrador de dados(AD):\
    ...
    iii. Modelo físico\
      ...
      **DESC** *nome_da_tabela*;\
      ...
      - Verificar em qual **DATABASE** esta conectado no momento e outros status do em uso.\
      **STATUS**\
...
- Na entidade associativa, o relacionamento N:N (muitos para muitos) foi dividido em dois relacionamentos do tipo 1:N (um para muitos), sendo a entidade associativa servindo de intermediario entre as entidades.\
