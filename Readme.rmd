...
- Para poder visualizar de maneira mais organizada atraves do dicionario, é interessante adicionar as chaves fora da criação de tabelas.\
...
- Os nomes das chaves podem ser consultados no dicionario do sistema e no: \
**SHOW CREATE TABLE** *nome_da_tabela*;\
